...
//        zooKeeper.create("/zk-persis-flj", "1".getBytes(),
//                ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);


        //exists  getdata getchildren
        //通过exists绑定事件
        Stat stat = zooKeeper.exists("/zk-persis-flj", new Watcher() {
            @Override
            public void process(WatchedEvent event) {
        ...
        stat = zooKeeper.setData("/zk-persis-flj", "2".getBytes(), stat.getVersion());
